    ...
    <div className="">
      ...
      <div className="modal bg-black/80">
        <div className="modal-box lg:w-6/12 w-11/12 max-w-5xl p-0 relative rounded-md grid lg:grid-cols-6 grid-cols-1">
          <label
            htmlFor="login-modal"
            className="absolute right-2 text-black hover:text-primary cursor-pointer fond-semibold top-1"
          >
            ✕
          </label>
          ...
          <div className="col-span-4 py-10 lg:px-7 px-5 flex flex-col  items-center justify-center">
            ...
            <div className="divider p-5 m-0 after:bg-gray-100 before:bg-gray-100 after:h-[1px] before:h-[1px] text-black/60 text-xs">
